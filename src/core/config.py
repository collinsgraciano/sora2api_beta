...
class Config:
    ...
    def __init__(self):
        ...
        self._impersonate_preset: str = "safari_ios"
    ...
    @property
    def impersonate_preset(self) -> str:
        return self._impersonate_preset

    def set_impersonate_preset(self, preset: str):
        """Set impersonate preset"""
        self._impersonate_preset = preset
